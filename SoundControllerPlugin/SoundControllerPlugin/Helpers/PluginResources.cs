namespace Loupedeck.SoundControllerPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.SoundControllerPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.SoundControllerPlugin.Resources.Resource.txt`.
